...
const variantClasses = computed(() => {
  const variants = {
    ...
    secondary: 'bg-white border-2 border-indigo-600 text-indigo-600 hover:bg-indigo-600 hover:text-white shadow-md hover:shadow-lg focus:ring-indigo-500/50 hover:scale-105',
