...
export const mockScenarios: Scenario[] = [
  ...
  },
  {
    ...
    description:
      "Habilidades de conversación profesional para entrevistas de trabajo",
    language: "Inglés",
    level: "advanced",
    duration: 45,
    status: "active",
...
export const mockConversationMessages: ConversationMessage[] = [
  ...
  },
  {
    ...
    score: 8.5,
    corrections: [
      'Considera usar "bajo el nombre de..." para especificar el nombre',
    ],
  },
  {
    id: "3",
