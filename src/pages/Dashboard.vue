...
<template>
  <div class="space-y-8 lg:space-y-12">
    <!-- Welcome Section -->
    <div
      class="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 rounded-3xl p-10 lg:p-12 text-white dark:from-indigo-800 dark:via-purple-800 dark:to-pink-800"
    >
    ...
    <Transition name="slide-left" mode="out-in" appear>
      <div key="dashboard-content" class="space-y-6 lg:space-y-8">
        <!-- Key Metrics -->
              ...
              <div class="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p class="text-gray-600 mt-1">
                    Seguimiento de resultados de aprendizaje a lo largo del
                    tiempo
                  </p>
                </div>
